...
| Author   | [Jay Logelin](mailto:jlogelin@fas.harvard.edu), [Infernal_toast](mailto:admin@0xbitcoin.org), [Michael Seiler](mailto:mgs33@cornell.edu), [Brandon Grill](mailto:bg2655@columbia.edu) |
| -------- | ------------------------------------------------------------ |
| Status   | Draft                                                        |
...
> 对 ICO 的分析，MT 其实是一种代币发行模式，是代币层面的设计
